...
public class ComentarioService {
    ...
    public void eliminarComentario(Long comentarioId, Usuario usuarioActual) {
        ...
        boolean esAdmin = usuarioActual.getRol() != null && usuarioActual.getRol().name().equals("ADMIN");
        boolean esAnfitrionDelHotel = usuarioActual.getRol() != null &&
                usuarioActual.getRol().name().equals("ANFITRION") &&
